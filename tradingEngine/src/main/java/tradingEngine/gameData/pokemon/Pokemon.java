...
public abstract class Pokemon {
    ...
    protected int level;
    protected int statusCondition;
    protected final int[] types = new int[2];
    protected int catchRate;
    protected final int[] moves = new int[4];
    protected int trainerId;
    protected int exp;
    protected final int[] evs = new int[5];
    protected final int[] ivs = new int[5];
    protected final int[] movesPps = new int[4];
    protected final int[] stats = new int[5];
    protected InGameString trainerName;
    protected InGameString nickname;
